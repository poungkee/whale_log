...
export class AuthController {
  ...
  async kakaoMobileCallback(
    ...
    try {
      ...
      const autoGen = result.usernameAutoGenerated ? '1' : '0';
      return res.redirect(`whalelog://oauth?token=${token}&user=${user}&isNewUser=${isNewUser}&usernameAutoGenerated=${autoGen}`);
    } catch (e) {
