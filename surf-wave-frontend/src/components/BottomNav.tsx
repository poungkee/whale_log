  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-card border-t border-border z-50 safe-bottom">
      ...
      <div
        ...
        style={{ fontSize: '10px', color: '#A09880', paddingBottom: '6px' }}
      >
        <a href="/terms.html" target="_blank" rel="noopener noreferrer"
          style={{ color: '#A09880' }} className="hover:underline">이용약관</a>
        <span style={{ color: 'rgba(160,140,110,0.35)' }}>|</span>
        <a href="/privacy.html" target="_blank" rel="noopener noreferrer"
          style={{ color: '#A09880' }} className="hover:underline">개인정보처리방침</a>
        <span style={{ color: 'rgba(160,140,110,0.35)' }}>|</span>
        <a href="mailto:poung1869@gmail.com"
          style={{ color: '#A09880' }} className="hover:underline">문의</a>
      </div>
    </nav>
  );
}
